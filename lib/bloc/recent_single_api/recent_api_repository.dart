...
class RecentSingleAPIRepository {
  RecentSingleAPIResponse? _makeSongResponse;

  RecentSingleAPIResponse? get makeSongResponse => _makeSongResponse;
  ...
  Future<void> partnerList(String id) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final responseData = RecentSingleAPIResponse.fromJson(responseJsonMap);
