...
class RecentSingleAPIRepository {
  RecentSingleModelResponse? _makeSongResponse;

  RecentSingleModelResponse? get makeSongResponse => _makeSongResponse;
  ...
  Future<void> recentSingleList(Map<String, dynamic> data) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _makeSongResponse = RecentSingleModelResponse.fromJson(responseJsonMap);
        _message = "Success";
        _success = true;
      } else {
        final responseJsonMap =
