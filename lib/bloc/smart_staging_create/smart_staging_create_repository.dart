...
class SmartStagingCreateRepository {
  SmartStagingCreateModelResponse? _makeSongResponse;

  SmartStagingCreateModelResponse? get makeSongResponse => _makeSongResponse;
  ...
  Future<void> smartStagingCreate(
