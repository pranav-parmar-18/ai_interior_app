...
class UploadProfilePictureRepository {
  ...
  Future<void> uploadProfilePicture(Map<String, dynamic> data) async {
    try {
      if (kDebugMode) {
      ...
      const String url = '${ProjectConstant.baseUrl}picture/upload';
