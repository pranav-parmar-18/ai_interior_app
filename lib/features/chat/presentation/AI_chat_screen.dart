...
import '../../../bloc/chat/delete_ai_message/delete_ai_message_bloc.dart';
...
class _AiChatScreenState extends State<AIChatScreen> {
  ...
  final SendAIMessageBloc _sendAIMessageBloc = SendAIMessageBloc();
  final GetAIMessageDetailsBloc _getAIMessageDetailsBloc =
      GetAIMessageDetailsBloc();
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<GetAIMessageDetailsBloc, GetAIMessageDetailsState>(
      bloc: _getAIMessageDetailsBloc,
      listener: (context, state) {
        if (state is GetAIMessageDetailsSuccessState) {
          getAiMessageDetailsResponse = state.getAiMessageDetails;
        ...
        } else if (state is GetAIMessageDetailsFailureState ||
            state is GetAIMessageDetailsFailureState) {}
      },
              ...
              builder: (context, giftState) {
                return BlocConsumer<DeleteAIMessageBloc, DeleteAIMessageState>(
                  ...
                  builder: (context, deleteState) {
                    return BlocConsumer<SendAIMessageBloc, SendAIMessageState>(
                      bloc: _sendAIMessageBloc,
                      listener: (context, state) {
                        if (state is SendAIMessageSuccessState) {
                        ...
                        } else if (state is SendAIMessageExceptionState ||
                            state is SendAIMessageFailureState) {}
                      },
                      builder: (context, sendMessageState) {
                        return state is GetAIMessageDetailsLoadingState &&
                                _isFirstTime == true
                            ? Stack(
                              children: [
                                Stack(
      ...
      actions: [
        CupertinoButton(
          ...
          onPressed: () {
            showReportDialog(
              context: context,
              contentId: aiMsgResults?.otherUserId?.toString() ??"",
              isMusicPlayer: true,
            );
          },
          ...
          child: Row(
            ...
            children: const [
              Icon(CupertinoIcons.flag, color: CupertinoColors.white, size: 20),
            ],
          ),
        ),
        SizedBox(width: 7),
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (state is SendAIMessageLoadingState)
                    Column(
                      children: [
  ...
  Future<void> showReportDialog({
    ...
    void sendReport(
      ...
      print(
        "Reported $contentId for $reason: $comment (isMusic: $isMusicPlayer)",
      );

      _deleteAIMessageBloc.add(DeleteAIMessageDataEvent(id: contentId));
    }
