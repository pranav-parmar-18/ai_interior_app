...
class DreamAshSelectionScreen extends StatefulWidget {
  static const routeName = "/dream-ash-selection";

  const DreamAshSelectionScreen({super.key});

  @override
  State<DreamAshSelectionScreen> createState() =>
      _DreamAshSelectionScreenState();
}
  ...
  Widget _buildRoomCard(RoomItem room, int index) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: ClipRRect(
          borderRadius: BorderRadius.circular(isSelected ? r.wp(context, 13.5) : r.wp(context, 16)),
          child: Stack(
            fit: StackFit.expand,
            children: [
              // Room image
