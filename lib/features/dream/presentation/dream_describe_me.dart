...
class DreamDescribeVisionScreen extends StatefulWidget {
  const DreamDescribeVisionScreen({super.key});

  static const routeName = "/intr-describe-vision";

  @override
  State<DreamDescribeVisionScreen> createState() =>
      _DreamDescribeVisionScreenState();
}

class _DreamDescribeVisionScreenState
    extends State<DreamDescribeVisionScreen> {
        ...
        return GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(r.adaptiveValue(context, mobile: 50, tablet: 60)),
              border: Border.all(
