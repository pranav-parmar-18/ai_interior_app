...
class InteriorAshSelectionScreen extends StatefulWidget {
  static const routeName = "/interior-ash-selection";

  const InteriorAshSelectionScreen({super.key});

  @override
  State<InteriorAshSelectionScreen> createState() =>
      _InteriorAshSelectionScreenState();
}
      ...
      child: AnimatedContainer(
        ...
        child: ClipRRect(
          borderRadius: BorderRadius.circular(
            isSelected ? cardRadius - 2.5 : cardRadius,
          ),
          child: Stack(
            fit: StackFit.expand,
            children: [
                      ...
                      return Container(
                        decoration: const BoxDecoration(
                          gradient: LinearGradient(
                            ...
                            colors: [Color(0xFFF0EDE8), Color(0xFFE5E0D8)],
                          ),
                        ),
                        child: Center(
                          child: Icon(
                            room.fallbackIcon,
                            size: r.adaptiveValue(
                              context,
                              mobile: 42,
                              tablet: 56,
                            ),
