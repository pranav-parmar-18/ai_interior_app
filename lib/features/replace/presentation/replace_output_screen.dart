...
class ReplaceOutputScreen extends StatefulWidget {
  const ReplaceOutputScreen({super.key});

  static const routeName = "/replace-output-screen";

  @override
  State<ReplaceOutputScreen> createState() => _ReplaceOutputScreenState();
}

class _ReplaceOutputScreenState extends State<ReplaceOutputScreen> {
...
class _ColorSwatches extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final double size = r.wp(context, 28.0);
...
class _BuildingIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      size: Size(r.wp(context, 30), r.hp(context, 30)),
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: AnimatedScale(
          ...
          child: Container(
            width: double.infinity,
            height: r.adaptiveValue(context, mobile: 54, tablet: 60),
            decoration: BoxDecoration(
