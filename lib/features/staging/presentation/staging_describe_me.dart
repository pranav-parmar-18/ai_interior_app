...
class StagingDescribeVisionScreen extends StatefulWidget {
  const StagingDescribeVisionScreen({super.key});

  static const routeName = "/staging-describe-vision";

  @override
  State<StagingDescribeVisionScreen> createState() =>
      _StagingDescribeVisionScreenState();
}

class _StagingDescribeVisionScreenState
    extends State<StagingDescribeVisionScreen> {
