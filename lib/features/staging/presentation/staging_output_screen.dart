...
class StagingOutputScreen extends StatefulWidget {
  ...
  static const routeName = "/staging-output-screen";

  @override
  State<StagingOutputScreen> createState() => _StagingOutputScreenState();
}

class _StagingOutputScreenState extends State<StagingOutputScreen> {
