...
class StyleOutputScreen extends StatefulWidget {
  const StyleOutputScreen({super.key});

  static const routeName = "/style-output-screen";

  @override
  State<StyleOutputScreen> createState() => _StyleOutputScreenState();
}

class _StyleOutputScreenState extends State<StyleOutputScreen> {
