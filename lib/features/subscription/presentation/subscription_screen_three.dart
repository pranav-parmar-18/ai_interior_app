...
//
//
// class SubscriptionThreeScreen extends StatefulWidget {
//   const SubscriptionThreeScreen({super.key});
//
//   static const routeName = "/subscription-three";
//
//   @override
//   State<SubscriptionThreeScreen> createState() => _SubscriptionThreeScreenState();
// }
//
// class _SubscriptionThreeScreenState extends State<SubscriptionThreeScreen> {
...
//                               ? FittedBox(
//                             fit: BoxFit.cover,
//                             child: SizedBox(height: height,width: width,child: VideoPlayer(_controller)),
//                           )
...
//                                   if (_currentView == 1) {
//                                     selectedProduct = (_selectedIndex == 1)
//                                         ? _productsWeekly[0]
//                                         : _products[1];
//                                   } else if (_currentView == 2) {
//                                     selectedProduct = _products[1];
//                                   } else {
//                                     selectedProduct = _products[_selectedIndex];
//                                   }
//
...
//                     ),
//                   Text(
//                     _loading ? "\$39.99":"${_getPrice("com.aigirlfriend.yearly")} per year",
//                     style: TextStyle(
//                       fontWeight: FontWeight.w700,
//                       fontFamily: 'Manrope',
//                       fontSize: width * 0.05,
...
//             children: [
//               Image.asset(
//                 'assets/images/subscription_top.png',
//                 width: imageWidth,
//                 fit: BoxFit.cover,
//               ),
//               Image.asset(
...
import '../../onboarding/presentation/first_onboarding_screen.dart';
...
// Main Screen
// ─────────────────────────────────────────────────────────────────────────────
class SubscriptionScreenThree extends StatefulWidget {
  const SubscriptionScreenThree({super.key});

  static const routeName = '/subscription-three';

  @override
  State<SubscriptionScreenThree> createState() =>
      _SubscriptionScreenThreeState();
}

class _SubscriptionScreenThreeState extends State<SubscriptionScreenThree>
