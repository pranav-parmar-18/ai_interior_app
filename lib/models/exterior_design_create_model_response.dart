class ExteriorDesignCreateModelResponse {
  final Data? data;
  final String? message;
  final int? status;

  ExteriorDesignCreateModelResponse({
    this.data,
    this.message,
    this.status,
  });

  factory ExteriorDesignCreateModelResponse.fromJson(Map<String, dynamic> json) => ExteriorDesignCreateModelResponse(
