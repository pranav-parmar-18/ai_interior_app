class GetAllInteriorDesignModelResponse {
  final String? message;
  final List<Datum>? data;
  final int? status;

  GetAllInteriorDesignModelResponse({
    this.message,
    this.data,
    this.status,
  });

  factory GetAllInteriorDesignModelResponse.fromJson(Map<String, dynamic> json) => GetAllInteriorDesignModelResponse(
