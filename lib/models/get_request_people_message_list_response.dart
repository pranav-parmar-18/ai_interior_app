class GetRequestPeopleRequestMessageListResponse {
  final bool? status;
  ...
  factory GetRequestPeopleRequestMessageListResponse.fromJson(Map<String, dynamic> json) => GetRequestPeopleRequestMessageListResponse(
    status: json["status"],
